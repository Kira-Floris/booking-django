...
urlpatterns = [
    ...
    path('hotels/update/photo/<str:pk>', updateHotel.as_view(), name='updatephotohotel'),
    ...
    path('rooms/create/', createRoom.as_view(), name='createroom'),
    path('rooms/<str:pk>', getRoom.as_view(), name='getroom'),
    path('rooms/update/<str:pk>', updateRoom.as_view(), name='updateroom'),
    path('rooms/update/photo/<str:pk>', updateRoom.as_view(), name='updatephotoroom'),
    path('rooms/delete/<str:pk>', deleteRoom.as_view(), name='deleteroom'),

    path('book/rooms/', getRoomBooks.as_view(), name='getroombooks'),
    path('rooms/<str:roomId>/book/', getRoomBooks.as_view(), name='getroombooks'),
    path('book/rooms/create/', createRoomBook.as_view(), name='createroombook'),
    path('book/rooms/<str:pk>', getRoomBook.as_view(), name='getroombook'),
    path('book/rooms/update/<str:pk>', updateRoomBook.as_view(), name='updateroombook'),
    path('book/rooms/delete/<str:pk>', deleteRoomBook.as_view(), name='deleteroombook'),
